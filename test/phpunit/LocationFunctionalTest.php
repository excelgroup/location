...
/**
 * \file    test/phpunit/LocationFunctionalTest.php
 * \ingroup location
 ...
 */
class LocationFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/location/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('location/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/location/admin/about.php');
		$this->authenticate();
		return $this->assertContains('location/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('locationwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modLocation_LocationTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modLocation_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
