...
print load_fiche_titre($langs->trans("Nouveau Demande"), '', 'maintenance.png@maintenance');
...
$contrat->update_contrat($id);

$data=$contrat->edit_form($id);

var_dump($data);

$data_form=$contrat->Form_contrat();


$annex=$contrat->list_annex($id);

$machine=$contrat->list_machine($id);


$DATA=['data'=>$data,'dataform'=>$data_form,'id'=>$id,'annex'=>$annex,'machine'=>$machine];
...
echo $twig->render('editContrat.twig', ['DATA'=>$DATA]);
