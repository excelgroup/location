...
print load_fiche_titre($langs->trans("Machines louee"), '', 'maintenance.png@maintenance');



$contrat=new ContratController($db);

$datafrom = $contrat->form_history($id);

$contrathistory = $contrat->contrat_history($id);

$contrat->edit_printer($id);

$interhistory=$contrat->history_inter($id);
...
echo $twig->render('historymachine.twig', ['data'=>$datafrom,'contrat'=>$contrathistory,'inter'=>$interhistory]);
